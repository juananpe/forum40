...
comment_parser_post.add_argument('source_id', required=True)
comment_parser_post.add_argument('user_id', default=None)
comment_parser_post.add_argument('parent_comment_id', default=None)
